var ClientRequest, EMPTY_IMAGE, IMAGE_FILE, LARGE_RAW_FILE, LARGE_VIDEO, Q, RAW_FILE, TEST_TAG, UPLOAD_TAGS, at, cloudinary, expect, fs, helper, http, https, isFunction, path, sinon, uploadImage;
...
describe("uploader", function() {
  ...
  it("should support requesting detection", function() {
    return cloudinary.v2.uploader.upload(IMAGE_FILE, {
      ...
      return expect(error.message).to.contain("is not a valid");
    });
  });
